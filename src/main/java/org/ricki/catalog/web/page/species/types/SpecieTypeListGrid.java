...
@GridMetadata(columns = {@ColumnInfo(columnCaption = "Название", fieldName = "name", width = 400)
        ...
        , @ColumnInfo(columnCaption = "Тд min", fieldName = "temprDayMin", width = 90)
        , @ColumnInfo(columnCaption = "Тд max", fieldName = "temprDayMax", width = 90)
        , @ColumnInfo(columnCaption = "Тн min", fieldName = "temprNightMin", width = 90)
        , @ColumnInfo(columnCaption = "Тн max", fieldName = "temprNightMax", width = 90)
