...
import org.ricki.catalog.web.abstracts.form.element.annotations.field.childTable.ChildTableFieldMetadata;
...
@FormMetadata(columnCount = 80, rowCount = 10, caption = "Действие", entityClass = AnAction.class, service = AnActionService.class)
